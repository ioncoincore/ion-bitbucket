...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/ionpay/gitian.sigs.git'])
    if not os.path.isdir('ion-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/ionpay/ion-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('ion'):
        subprocess.check_call(['git', 'clone', 'https://github.com/ionpay/ion.git'])
...
def build():
    ...
    os.makedirs('ioncore-binaries/' + args.version, exist_ok=True)
    ...
    if args.linux:
        ...
        subprocess.check_call('mv build/out/ioncore-*.tar.gz build/out/src/ioncore-*.tar.gz ../ioncore-binaries/'+args.version, shell=True)
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/ioncore-*-win-unsigned.tar.gz inputs/ioncore-win-unsigned.tar.gz', shell=True)
        subprocess.check_call('mv build/out/ioncore-*.zip build/out/ioncore-*.exe ../ioncore-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/ioncore-*-osx-unsigned.tar.gz inputs/ioncore-osx-unsigned.tar.gz', shell=True)
        subprocess.check_call('mv build/out/ioncore-*.tar.gz build/out/ioncore-*.dmg ../ioncore-binaries/'+args.version, shell=True)
...
def sign():
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/ioncore-*win64-setup.exe ../ioncore-binaries/'+args.version, shell=True)
        subprocess.check_call('mv build/out/ioncore-*win32-setup.exe ../ioncore-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/ioncore-osx-signed.dmg ../ioncore-binaries/'+args.version+'/ioncore-'+args.version+'-osx.dmg', shell=True)
...
def verify():
    ...
    subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-linux', '../ion/contrib/gitian-descriptors/gitian-linux.yml'])
    print('\nVerifying v'+args.version+' Windows\n')
    subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-unsigned', '../ion/contrib/gitian-descriptors/gitian-win.yml'])
    print('\nVerifying v'+args.version+' MacOS\n')
    subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-unsigned', '../ion/contrib/gitian-descriptors/gitian-osx.yml'])
    print('\nVerifying v'+args.version+' Signed Windows\n')
    subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-signed', '../ion/contrib/gitian-descriptors/gitian-win-signer.yml'])
    print('\nVerifying v'+args.version+' Signed MacOS\n')
    subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-signed', '../ion/contrib/gitian-descriptors/gitian-osx-signer.yml'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/ionpay/ion', help='Specify the URL of the repository. Default is %(default)s')
